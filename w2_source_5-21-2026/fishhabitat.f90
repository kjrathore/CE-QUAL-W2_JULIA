...
USE GLOBAL;USE MAIN;USE SCREENC; USE KINETIC, ONLY:O2, CHLA, NO3,NH4,PO4, TP, GAMMA, SED, SATO; USE NAMESC, ONLY: CNAME2,CDNAME2; USE LOGICC
IMPLICIT NONE
INTEGER :: IFISH, N, NSEG,IOPENFISH,KKMAX,KSEG,JJW,JWFILE,JBFILE, X   
